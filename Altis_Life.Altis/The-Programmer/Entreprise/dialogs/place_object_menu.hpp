...
class entreprise_objects_place_menu {
   ...
   class controls
   {
       ...
       class DeleteButton : Life_RscButtonMenu
       {
           ...
           onbuttonclick = "[] spawn max_entreprise_fnc_removeObject;";
           x = 0.416875 * safezoneW + safezoneX;
           y = 0.588397246804327 * safezoneH + safezoneY;
           w = 0.076875 * safezoneW;
           h = 0.022 * safezoneH;
           class Attributes {align = "center";};
       };
       class PlaceButton : Life_RscButtonMenu
       {
           idc = 5484;
           text = "";
           colorbackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
           onbuttonclick = "[] spawn max_entreprise_fnc_placeObject;";
           x = 0.50125 * safezoneW + safezoneX;
           y = 0.588397246804327 * safezoneH + safezoneY;
           w = 0.076875 * safezoneW;
           h = 0.022 * safezoneH;
           class Attributes {align = "center";};
